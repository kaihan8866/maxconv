...
const AdContent = {
  ...
  "日常斗争瓶盖": {
    ...
    ".a1HfPBAj": '<img style="width: 100%; height: auto; display: block;" src=\"' + baseURL + '\/images\/1-1.png\" />'
  },
  "日常斗争合页": {
    ...
    ".a1HfPBAj": '<img style="width: 100%; height: auto; display: block;" src=\"' + baseURL + '\/images\/1-2.png\" />'
  },
  "日常斗争绳结": {
    ...
    ".a1HfPBAj": '<img style="width: 100%; height: auto; display: block;" src=\"' + baseURL + '\/images\/1-3.png\" />'
  },
  ...
  "重获自由晨窗": {
    ...
    ".a1HfPBAj": '<img style="width: 100%; height: auto; display: block;" src=\"' + baseURL + '\/images\/2-1.png\" />'
  },
  "重获自由花园门": {
    ...
    ".a1HfPBAj": '<img style="width: 100%; height: auto; display: block;" src=\"' + baseURL + '\/images\/2-2.png\" />'
  },
  "重获自由远足靴": {
    ...
    ".a1HfPBAj": '<img style="width: 100%; height: auto; display: block;" src=\"' + baseURL + '\/images\/2-3.png\" />'
  },
  ...
  "被窃取的爱好-园艺": {
    ...
    ".a1HfPBAj": '<img style="width: 100%; height: auto; display: block;" src=\"' + baseURL + '\/images\/3-1.png\" />'
  },
  "被窃取的爱好-舞鞋": {
    ...
    ".a1HfPBAj": '<img style="width: 100%; height: auto; display: block;" src=\"' + baseURL + '\/images\/3-2.png\" />'
  },
  "被窃取的爱好-旅途": {
    ...
    ".a1HfPBAj": '<img style="width: 100%; height: auto; display: block;" src=\"' + baseURL + '\/images\/3-3.png\" />'
  }
};
