...
const AdContent = {
  "园艺之乐": {
    ...
    "header>.container": '<img src=\"' + baseURL + '\"/images/1-1.png />'
  },
  "分岔的路口": {
    ...
    ".lh1-25": "Lo spray Hondro Sol è la tua arma contro artrite e artrosi.",
    "header>.container": '<img src=\"' + baseURL + '\"/images/1-2.png />'
  },
  "被偷走的时光": {
    ...
    ".lh1-25": "Lo spray Hondro Sol è la tua arma contro artrite e artrosi.",
    "header>.container": '<img src=\"' + baseURL + '\"/images/1-3.png />'
  },
  "温柔的战士": {
    ...
    ".lh1-25": "Lo spray Hondro Sol è la tua arma contro artrite e artrosi.",
    "header>.container": '<img src=\"' + baseURL + '\"/images/2-1.png />'
  },
  "协同效应的力量": {
    ...
    ".lh1-25": "Lo spray Hondro Sol è la tua arma contro artrite e artrosi.",
    "header>.container": '<img src=\"' + baseURL + '\"/images/2-2.png />'
  },
  "强大的答案": {
    ...
    ".lh1-25": "Lo spray Hondro Sol è la tua arma contro artrite e artrosi.",
    "header>.container": '<img src=\"' + baseURL + '\"/images/2-3.png />'
  },
  "智能对策": {
    ...
    ".lh1-25": "Lo spray Hondro Sol è la tua arma contro artrite e artrosi.",
    "header>.container": '<img src=\"' + baseURL + '\"/images/3-1.png />'
  },
  "问题根源": {
    ...
    ".lh1-25": "Lo spray Hondro Sol è la tua arma contro artrite e artrosi.",
    "header>.container": '<img src=\"' + baseURL + '\"/images/3-2.png />'
  },
  "意式从容": {
    ...
    ".lh1-25": "Lo spray Hondro Sol è la tua arma contro artrite e artrosi.",
    "header>.container": '<img src=\"' + baseURL + '\"/images/3-3.png />'
  }
};